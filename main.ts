namespace SpriteKind {
    ...
    export const Black3d = SpriteKind.create()
    export const Grandma = SpriteKind.create()
    export const Door_G = SpriteKind.create()
    export const axel = SpriteKind.create()
    export const door_van = SpriteKind.create()
    export const Roll = SpriteKind.create()
}
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    if (Mouse_.overlapsWith(play_)) {
    ...
    if (Mouse_.overlapsWith(axelbutton)) {
        music.baDing.play()
        animation.runImageAnimation(
        Mouse_,
        [img`
        ...
        story.printText("easter egg!!! (2302)", 400, 345, 1, 15, story.TextSpeed.Slow)
        axelbutton.destroy()
    }
    if (Mouse_.overlapsWith(roll)) {
        if (game.askForNumber("Locked, enter password") == 2302) {
            tiles.setTilemap(tilemap`level19`)
            game.showLongText("if you are here, surely you have found \"Easter egg\".  you have unlocked an additional ending.", DialogLayout.Center)
        } else {
            mouse2 = sprites.create(img`
                . . . . . . . . . . . . . . . . 
                . . . . . . . . . . . . . . . . 
                . . . . . . . . . . . . . . . . 
                . . . . . . . . . . . . . . . . 
            ...
            mouse2.setPosition(400, 439)
            Mouse_.setStayInScreen(true)
            controller.moveSprite(mouse2, 20, 20)
            tiles.setTilemap(tilemap`level17`)
            tiles.setTileAt(tiles.getTileLocation(4, 4), assets.tile`myTile145`)
            roll = sprites.create(img`
                . . . . . . . . . . . . . . . . 
                . . . . . . . . . . . . . . . . 
                . . . . . . . . . . . . . . . . 
                . . . . . . . . . . . . . . . . 
                ...
                . . . . . . . . . . . . . . . . 
                `, SpriteKind.Roll)
            tiles.placeOnTile(roll, tiles.getTileLocation(8, 5))
        }
    }
})
...
sprites.onOverlap(SpriteKind.Mouse, SpriteKind.Roll, function (sprite, otherSprite) {
    if (game.askForNumber("Locked, enter password") == 2302) {
        tiles.setTilemap(tilemap`level19`)
        game.showLongText("if you are here, surely you have found \"Easter egg\".  you have unlocked an additional ending.", DialogLayout.Center)
    } else {
        ...
        tiles.setTilemap(tilemap`level17`)
        tiles.setTileAt(tiles.getTileLocation(4, 4), assets.tile`myTile145`)
        roll.setFlag(SpriteFlag.Invisible, false)
        tiles.placeOnTile(roll, tiles.getTileLocation(8, 5))
    }
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Door_G, function (sprite, otherSprite) {
    grandmas_door.destroy()
    pause(500)
    Johnny.destroy()
    tiles.setTilemap(tilemap`level17`)
    pause(2000)
    if (game.askForNumber("Locked, enter password") == 2302) {
        ...
        tiles.placeOnTile(mouse2, tiles.getTileLocation(4, 5))
        mouse2.setStayInScreen(true)
        controller.moveSprite(mouse2, 20, 20)
        tiles.setTilemap(tilemap`level17`)
        tiles.setTileAt(tiles.getTileLocation(4, 4), assets.tile`myTile145`)
...
sprites.onOverlap(SpriteKind.jhonny_in_van, SpriteKind.Stick, function (sprite, otherSprite) {
    ...
    controller.moveSprite(jhonny_in_van2, 0, 0)
    jhonny_in_van2.setVelocity(15, 0)
    animation.runImageAnimation(
    Van2,
    [img`
        . . . . . . . . . . . . . . . . 
...
sprites.onOverlap(SpriteKind.Grandma, SpriteKind.Door_G, function (sprite, otherSprite) {
    grandma.destroy()
})
sprites.onOverlap(SpriteKind.jhonny_in_van, SpriteKind.Black3d, function (sprite, otherSprite) {
    black3D.destroy()
    Van2.destroy()
    ...
    Johnny = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Player)
    Johnny.setPosition(32, 224)
    scene.cameraFollowSprite(Johnny)
    tiles.setTilemap(tilemap`level12`)
    controller.moveSprite(Johnny, 0, 0)
    story.startCutscene(function () {
        story.spriteSayText(Johnny, "b...but this is my neighborhood", 1, 15, story.TextSpeed.Slow)
    })
    pause(2000)
    grandmas_door = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Door_G)
    tiles.placeOnTile(grandmas_door, tiles.getTileLocation(0, 0))
    pause(100)
    grandma = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Grandma)
    tiles.placeOnTile(grandma, tiles.getTileLocation(26, 11))
    animation.runImageAnimation(
    grandma,
    [img`
        . . . . . . . . . . . . . . . . 
...
sprites.onOverlap(SpriteKind.one, SpriteKind.zero, function (sprite, otherSprite) {
    ...
    controller.moveSprite(Johnny, 40, 30)
...
sprites.onOverlap(SpriteKind.Grandma, SpriteKind.Player, function (sprite, otherSprite) {
    tiles.placeOnTile(grandmas_door, tiles.getTileLocation(26, 11))
    grandma.follow(Johnny, 0)
    story.printText("Where have you been?      Come home...", 50, 224, 1, 15)
    grandma.follow(grandmas_door, 20)
    pause(500)
    Johnny.follow(grandmas_door, 20)
})
...
let no_play2: Sprite = null
let axelbutton: Sprite = null
...
axelbutton = sprites.create(img`
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.axel)
axelbutton.setPosition(462, 441)
no_play2 = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
...
roll = sprites.create(img`
    ...
    `, SpriteKind.Roll)
tiles.placeOnTile(roll, tiles.getTileLocation(8, 5))
roll.setFlag(SpriteFlag.Invisible, true)
